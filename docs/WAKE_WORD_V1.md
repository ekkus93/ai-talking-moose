...
The repository contains the real pinned sherpa-onnx native KWS session, immutable model/runtime manifests, canonical PCM routing, pre-roll/live handoff primitives, command-ASR ingress, lifecycle guards, settings UI, diagnostics, and deterministic component/lifecycle tests. **Wake Word V1 is not yet fully production-qualified.** The original remediation reached closeout, but the post-closeout review reopened integration requirements around listener ownership, live Settings changes, manual shared-capture transfer, downstream first-command-word acceptance, production-listener performance, documentation/gates, and final requalification. Those items are tracked in `docs/WAKE_WORD_V1_POST_CLOSEOUT_REMEDIATION_TODO_2026-09-25.md`. Do not interpret prior WWR acceptance evidence as closure of these newer WPCR requirements.
...
The original remediation specification/checklist are `docs/WAKE_WORD_V1_REMEDIATION_SPEC_2026-09-17.md` and `docs/WAKE_WORD_V1_REMEDIATION_TODO_2026-09-17.md`. The authoritative live remediation queue is now `docs/WAKE_WORD_V1_POST_CLOSEOUT_REMEDIATION_TODO_2026-09-25.md`, with `docs/WAKE_WORD_V1_POST_CLOSEOUT_REMEDIATION_SPEC_2026-09-25.md` defining the reopened scope. Architecture consolidation evidence is in `docs/evidence/WWR-020_WAKE_WORD_ARCHITECTURE_CONSOLIDATION_2026-09-17.md`; capture ownership/routing evidence is in the WWR-300 evidence files; handoff evidence is `docs/evidence/WWR-310_HANDOFF_BOUNDARY_2026-09-22.md`; diagnostics/privacy evidence is linked from WWR-510 in the remediation TODO; WPCR-400 provisioning evidence is `docs/evidence/WPCR-400_ARTIFACT_PROVISIONING_MODEL_2026-09-25.md`.
