...
/// Apply the generation-prompt portion of model-family policy after the local runtime has
/// validated the GGUF's embedded family invariants and rendered deterministic family ChatML.
///
